    ...
    <div className="w-full h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center">
        <div className="text-center text-white">
          <h1 className="text-6xl lg:text-7xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 leading-tight">
            {header.name}
          </h1>
          ...
          <div className="pt-4">
            <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-medium rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25">
              Explore My Cave
            </button>
          </div>
        </div>
      ...
      <Canvas className="w-full h-full" shadows>
        ...
        {/* Decorative crystals */}
        <DecorativeCrystal position={[15, 0, 15]} color="#8b5cf6" />
        <DecorativeCrystal position={[-15, 0, 15]} color="#ec4899" />
        <DecorativeCrystal position={[15, 0, -15]} color="#06b6d4" />
        <DecorativeCrystal position={[-15, 0, -15]} color="#f59e0b" />
        
        {/* Mini models */}
        <MiniModel model="pickaxe" position={[25, -5, 25]} />
        <MiniModel model="shovel" position={[-25, -5, 25]} />
        <MiniModel model="crystal" position={[25, -5, -25]} />
        <MiniModel model="campfire" position={[-25, -5, -25]} />
      </Canvas>
    </div>
  );
};
