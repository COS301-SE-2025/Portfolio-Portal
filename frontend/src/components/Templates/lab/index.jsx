      ...
      <div className="w-full h-screen relative overflow-hidden">
        ...
        <div className="absolute bottom-4 right-4 z-10">
          <div className="group relative">
            <button className="w-8 h-8 rounded-full bg-gray-800 bg-opacity-50 text-white text-xs flex items-center justify-center hover:bg-opacity-70 transition-all">
              ©
            </button>
