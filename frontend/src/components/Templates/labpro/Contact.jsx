    ...
    <section id="contact" className="relative w-full py-20 mx-auto bg-gray-900/30">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-teal-400 text-4xl font-bold mb-4">Research Collaboration</h2>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-gray-900/70 p-8 rounded-2xl backdrop-blur-sm border border-amber-400/20">
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="px-8 py-3 bg-gradient-to-r from-teal-400 to-amber-400 hover:from-teal-500 hover:to-amber-500 text-gray-900 font-bold rounded-lg transition-colors duration-300"
              >
                Submit Inquiry
              </button>
            </form>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gray-900/70 p-8 rounded-2xl backdrop-blur-sm border border-amber-400/20 max-w-2xl mx-auto">
