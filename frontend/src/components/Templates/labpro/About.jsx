    ...
    <section id="about" className="relative w-full py-20 mx-auto bg-gray-900/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-cyan-400 text-4xl font-bold mb-4">Research Methodology</h2>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="bg-gray-900/70 p-8 rounded-2xl backdrop-blur-sm border border-cyan-400/20">
            ...
            <div className="flex items-center mt-6">
              <div className="w-16 h-16 rounded-full bg-cyan-400/10 border border-cyan-400/30 flex items-center justify-center mr-4">
              ...
              {cvData?.skills?.slice(0, 4).map((skill, index) => (
                <div key={index}>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-cyan-400">{95 - (index * 5)}%</span>
                  </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-700">
                ...
                <div className="flex flex-wrap gap-2">
                  {cvData.skills.slice(4).map((skill, index) => (
                    <span 
                      key={index}
                      className="px-3 py-1 bg-gradient-to-r from-cyan-400/10 to-purple-400/10 text-cyan-300 rounded-full text-sm border border-cyan-400/30"
                    >
                      {skill}
                    </span>
                  ))}
