    ...
    <section id="about" className="relative w-full py-20 mx-auto bg-gray-900/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-green-400 text-4xl font-bold mb-4">Research Methodology</h2>
          <div className="w-20 h-1 bg-gradient-to-r from-green-400 via-purple-400 to-red-400 mx-auto" />
        </div>
          ...
          <div className="bg-gray-900/70 p-8 rounded-2xl backdrop-blur-sm border border-green-400/20">
            ...
            <div className="flex items-center mt-6">
              ...
              <div>
                ...
                <p className="text-red-400 text-sm">Peer-reviewed projects only</p>
              </div>
            </div>
          </div>
