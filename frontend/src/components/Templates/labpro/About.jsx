    ...
    <section id="about" className="relative w-full py-20 mx-auto bg-gray-900/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-blue-400 text-4xl font-bold mb-4">Research Methodology</h2>
              ...
              {cvData?.skills?.slice(0, 4).map((skill, index) => (
                <div key={index}>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div 
                      className="bg-gradient-to-r from-blue-400 to-amber-400 h-2 rounded-full transition-all duration-1000 ease-out" 
