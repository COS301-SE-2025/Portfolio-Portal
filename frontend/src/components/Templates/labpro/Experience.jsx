    ...
    <section id="experience" className="relative w-full py-20 mx-auto bg-gray-900/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-green-400 text-4xl font-bold mb-4">Research Journey</h2>
        ...
        <div className="space-y-8">
          {cvData?.experience?.map((exp, index) => (
            <div 
              key={index}
              className="bg-gray-900/70 p-8 rounded-2xl backdrop-blur-sm border border-green-400/20 hover:border-green-400/50 transition-all duration-300"
            >
              ...
              <h4 className="text-green-400 text-lg mb-4">{exp.company}</h4>
              {exp.extra?.length > 0 && (
        ...
        {cvData?.education?.length > 0 && (
          <div className="mt-20">
            <div className="text-center mb-16">
              <h2 className="text-green-400 text-4xl font-bold mb-4">Education & Certifications</h2>
              <div className="w-20 h-1 bg-green-400 mx-auto" />
            </div>
            ...
            <div className="space-y-8">
              {cvData.education.map((edu, index) => (
                ...
                >
                  ...
                  <h4 className="text-green-400 text-lg mb-2">{edu.institution}</h4>
