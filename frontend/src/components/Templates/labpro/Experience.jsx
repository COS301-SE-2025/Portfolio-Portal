    ...
    <section id="experience" className="relative w-full py-20 mx-auto bg-gray-900/20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-emerald-400 text-4xl font-bold mb-4">Research Career</h2>
        ...
        <div className="space-y-8">
          {cvData?.experience?.map((exp, index) => (
            <div 
              key={index}
              className="bg-gray-900/80 p-8 rounded-2xl backdrop-blur-sm border border-emerald-400/20 hover:border-emerald-400/50 transition-all duration-300"
            >
              ...
              <h4 className="text-emerald-400 text-lg mb-4">{exp.company}</h4>
              {exp.extra?.length > 0 && (
