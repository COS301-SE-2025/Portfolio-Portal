  ...
  return (
    <section id="about" className="relative w-full py-20 mx-auto">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="flex-1 bg-[#0a0a2e]/70 p-8 rounded-2xl backdrop-blur-sm border border-purple-400/20">
            <h3 className="text-purple-400 text-2xl font-bold mb-4">About Me</h3>
          ...
          <div className="flex-1 flex flex-wrap gap-10 justify-center">
            {skills?.map((skill, index) => (
              <div
                key={`skill-${index}`}
                className="w-full lg:w-[45%] bg-[#0a0a2e]/70 p-6 rounded-2xl backdrop-blur-sm border border-purple-400/20"
              >
