...
const GitHubDeploy = ({ userData, template, onDeploySuccess }) => {
  ...
  const themes = {
    default: {
      ...
      manualBg: 'bg-orange-50',
      manualBorder: 'border-orange-200',
      manualIcon: 'text-orange-600',
      manualHeader: 'text-orange-800',
      manualText: 'text-orange-700',
      manualCodeBg: 'bg-orange-100',
      manualCodeBorder: 'border-orange-200',
      manualCodeText: 'text-orange-800',
      manualCopy: 'text-orange-600 hover:text-orange-800',
      manualPreBg: 'bg-white',
      manualPreText: 'text-orange-800',
      backdropBlur: '',
    },
    space: {
      ...
      deployButtonText: 'text-white',
      manualBg: 'bg-orange-900/50',
      manualBorder: 'border-orange-800/50',
      manualIcon: 'text-orange-400',
      manualHeader: 'text-orange-300',
      manualText: 'text-orange-200',
      manualCodeBg: 'bg-orange-900/70',
      manualCodeBorder: 'border-orange-800/50',
      manualCodeText: 'text-orange-200',
      manualCopy: 'text-orange-400 hover:text-orange-200',
      manualPreBg: 'bg-gray-900',
      manualPreText: 'text-orange-200',
    ...
    cave: {
      ...
      deployButtonText: 'text-white',
      manualBg: 'bg-orange-900/50',
      manualBorder: 'border-orange-700/30',
      manualIcon: 'text-orange-400',
      manualHeader: 'text-orange-200',
      manualText: 'text-orange-100',
      manualCodeBg: 'bg-orange-800/50',
      manualCodeBorder: 'border-orange-700/30',
    ...
    office: {
      ...
      labelText: 'text-gray-700',
      inputBg: 'bg-white',
      inputBorder: 'border-gray-300 focus:ring-purple-500',
      inputText: 'text-gray-900',
      repoNoteText: 'text-gray-500',
