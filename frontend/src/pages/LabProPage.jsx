...
const LabProPage = () => {
  return (
    <div className='relative z-0 bg-gray-900 text-white overflow-hidden'>
      {/* Emerald Blur Lights Background - Professional Lab Theme */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-20 w-60 h-60 bg-emerald-400 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-pulse delay-1500"></div>
        {/* Professional scientific elements */}
        <div className="absolute top-1/2 left-1/4 w-40 h-40 bg-teal-300 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse delay-700"></div>
        <div className="absolute bottom-1/3 right-1/3 w-32 h-32 bg-cyan-300 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse delay-1200"></div>
      </div>
